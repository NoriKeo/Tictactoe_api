...
public class Playername {
   ...
   /* public static void startHttpServer(int port) throws IOException {
        ...
        server.createContext("/api/playername", new PlayerNameHandler());
        server.createContext("/api/password", new PasswordHandler());
        server.createContext("/api/security", new SecurityAnswerHandler());
        server.createContext("/api/start", new StartHandler());
        server.createContext("/api/creataccount", new CreatAccountHandler());
        server.createContext("/api/newpasswort", new newPasswordHandler());
        server.start();
